...
class ProvisorioProdutosDaMesaFood extends Migration
{
	public function up()
	{
		$this->forge->addField([
		...
		$this->forge->createTable('provisorio_produtos_da_mesa_food');
	}
	...
	{
		$this->forge->dropTable('provisorio_produtos_da_mesa_food');
	}
}
