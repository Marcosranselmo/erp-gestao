...
class ProvisorioAddProdutoPorXml extends Migration
{
	public function up()
	{
		$this->forge->addField([
		...
		$this->forge->createTable('provisorio_add_produto_por_xml');
	}
	...
	{
		$this->forge->dropTable('provisorio_add_produto_por_xml');
	}
}
